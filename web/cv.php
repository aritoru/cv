...
<div
	...
	<p>
		<code>
			<span class="orange-coded">#</span> <strong>Twelve years of
				passionate software development</strong><br /> <span
				class="orange-coded">#</span> <strong>Seven years of engineering in
				startup companies</strong><br /> <span class="orange-coded">#</span>
			<strong>Six Years of experience managing IT teams</strong><br /> <span
				class="orange-coded">#</span> <strong>Three years working on Agile
				teams</strong><br /> <span class="orange-coded">#</span> <strong>Expertise
				in building sw/hw cloud projects from scratch</strong><br /> <span
				class="orange-coded">#</span> <strong>Agile, TDD &amp; Continuous
				Integration evangelist</strong><br /> <span class="orange-coded">#</span>
			<strong>Experience managing and developing web and mobile projects</strong><br />
		</code>
	</p>
	...
	<!-- 2 cols -->
	<div class="block">
		<h3 class="heading">IT Manager at BlinkBooking.com</h3>
		<p>
			<img src="img/companies/blink.png"
				style="float: left; margin-right: 5px;" /><a
				href="http://www.blinkbooking.com">www.blinkbooking.com</a><br /> <i>March
				2012 - Now</i>
		</p>
		<p>
			<code>
				<span class="orange-coded">Blink Booking is the same day hotels
					booking app for premium boutique hotels across Europe.</span>
			</code>
		</p>
		<p>
	...
	<div class="block">
		...
		<p>
			<img src="img/companies/fon.png"
				style="float: left; margin-right: 5px;" /><a
				href="http://www.fon.com">www.fon.com</a><br /> <i>June 2006 - March
				2012</i>
		</p>
		<p>
			<code>
				<span class="orange-coded">Fon is the world's first global WiFi
					network built by people like you. Fon thinks of it as crowdsourced
					WiFi.</span>
			</code>
		</p>
	...
	<!-- 3 cols -->
	<div class="one-half">
		<h3 class="heading">Engineer at Azertia</h3>
		<p>
	...
	<div class="one-half last">
		<h3 class="heading">Analyst at Sitel</h3>
		<p>
	...
	<div class="one-half">
		...
		<p>
			<span class="orangized"><strong>English</strong></span><br />Medium / High
		</p>
		<p>
			<span class="orangized"><strong>German</strong></span><br />Just a little bit
		</p>
...
<aside id="sidebar">
	<div class="block">
		<img src="img/profile2.jpg" title="My Picture" alt="Profile"
			style="float: right" />
